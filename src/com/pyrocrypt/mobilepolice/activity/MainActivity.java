...
public class MainActivity extends ActionBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		com.pyrocrypt.mobilepolice.data.PreferenceManager preferenceManager = com.pyrocrypt.mobilepolice.data.PreferenceManager
				.getInstance();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case (R.id.action_settings):
			Intent intent1 = new Intent(this,
					com.pyrocrypt.mobilepolice.activity.SettingsActivity.class);
			startActivity(intent1);
			return true;

		case (R.id.action_about):
			Intent intent2 = new Intent(this,
					com.pyrocrypt.mobilepolice.activity.AboutActivity.class);
			startActivity(intent2);
			return true;

		case (R.id.action_help):
			Intent intent3 = new Intent(this,
					com.pyrocrypt.mobilepolice.activity.HelpActivity.class);
